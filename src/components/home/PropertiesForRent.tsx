    ...
    <section className="py-12 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col mb-10 border-l-[6px] border-[#b28e5a] pl-6">
          ...
          <h2 className="text-4xl font-black text-gray-800 uppercase tracking-tight">For Rent</h2>
        </div>
        ...
        <Swiper
          ...
          pagination={{ 
            clickable: true,
            bulletClass: 'swiper-pagination-bullet !bg-[#6b46c1] !opacity-30',
          ...
          {properties.map((property) => (
            <SwiperSlide key={property.id}>
              ...
              >
                ...
                {/* Status Tag - Purple for Rent */}
                <div className="absolute top-4 left-4 bg-indigo-600 text-white text-[10px] font-bold px-3 py-1 uppercase tracking-widest rounded-xs">
                  {property.status}
                </div>
